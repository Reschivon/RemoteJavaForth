...
import org.firstinspires.ftc.teamcode.ourOpModes.BTDebug.BluetoothDebugBare;
...
//       for(int i=0;i<30;i++){
    ...
    public void interpret() {
        ...
        BluetoothDebugBare.t.addData("newxt word in stream ", next_Word);
        BluetoothDebugBare.t.update();
